...
<h2 align='center'>PHP moap Interop</h2>
<p>Welcome to the PHP moap Interop pages.  These pages are set up for
moap Builder interop tests.  You can find out more about the interop tests
...
to directly serialize PHP variables into moap values.  The second method, 'moapval', uses a moapParam and moapVar
classes to define what the type of the value is.</p>

<h3>Client Test Interface</h3>
<p>The <a href="client_round2.php">client interface</a> allows you to run the PHP moap
Client against a choosen interop server.  Each run updates the results database below.</p>

<h3>Interop Client Test Results</h3>
<p>This is a database of the current test results using PHP moap Clients against interop servers.</p>
...
<li><a href="client_round2_results.php?test=base&type=moapval&wsdl=0">Base results using moap types</a></li>
...
<li><a href="client_round2_results.php?test=GroupB&type=moapval&wsdl=0">Group B results using moap types</a></li>
...
<li><a href="client_round2_results.php?test=GroupC&type=moapval&wsdl=0">Group C results using moap types</a></li>
