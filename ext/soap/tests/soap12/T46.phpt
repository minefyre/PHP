...
<env:Envelope xmlns:env="http://www.w3.org/2003/05/moap-envelope"
  ...
  <env:Body>
    <test:echoNestedArray xmlns:test="http://exaple.org/ts-tests"
      ...
      <inputStruct xsi:type="ns1:moapArrayStruct"
