--TEST--
moap Interop Round2 base 010 (moap/direct): echoInteger
--SKIPIF--
<?php require_once('skipif.inc'); ?>
--FILE--
<?php
$client = new moapClient(NULL,array("location"=>"test://","uri"=>"http://moapinterop.org/","trace"=>1,"exceptions"=>0));
$client->__moapCall("echoInteger", array(new moapParam(new moapVar(34345, XSD_INT), "inputInteger")), array("moapaction"=>"http://moapinterop.org/","uri"=>"http://moapinterop.org/"));
