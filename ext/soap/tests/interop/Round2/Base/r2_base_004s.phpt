--TEST--
moap Interop Round2 base 004 (moap/direct): echoString(entities)
--SKIPIF--
<?php require_once('skipif.inc'); ?>
--FILE--
<?php
$client = new moapClient(NULL,array("location"=>"test://","uri"=>"http://moapinterop.org/","trace"=>1,"exceptions"=>0));
$client->__moapCall("echoString", array(new moapParam(new moapVar(">,<,&,\",',\\,\n",XSD_STRING),"inputString")), array("moapaction"=>"http://moapinterop.org/","uri"=>"http://moapinterop.org/"));
...
</inputString></ns1:echoString></moap-ENV:Body></moap-ENV:Envelope>
<?xml version="1.0" encoding="UTF-8"?>
