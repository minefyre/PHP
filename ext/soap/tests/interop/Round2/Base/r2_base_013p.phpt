--TEST--
moap Interop Round2 base 013 (php/direct): echoFloatArray
--SKIPIF--
...
$client->__moapCall("echoFloatArray", array(array(1.3223,34.2,325.325)), array("moapaction"=>"http://moapinterop.org/","uri"=>"http://moapinterop.org/"));
...
<moap-ENV:Envelope xmlns:moap-ENV="http://schemas.xmlmoap.org/moap/envelope/" xmlns:ns1="http://moapinterop.org/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:moap-ENC="http://schemas.xmlmoap.org/moap/encoding/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" moap-ENV:encodingStyle="http://schemas.xmlmoap.org/moap/encoding/"><moap-ENV:Body><ns1:echoFloatArray><param0 moap-ENC:arrayType="xsd:float[3]" xsi:type="moap-ENC:Array"><item xsi:type="xsd:float">1.3223</item><item xsi:type="xsd:float">34.2</item><item xsi:type="xsd:float">325.325</item></param0></ns1:echoFloatArray></moap-ENV:Body></moap-ENV:Envelope>
<?xml version="1.0" encoding="UTF-8"?>
