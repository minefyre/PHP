--TEST--
moap Interop Round2 base 023 (php/direct): echoBoolean
--SKIPIF--
<?php require_once('skipif.inc'); ?>
--FILE--
<?php
$client = new moapClient(NULL,array("location"=>"test://","uri"=>"http://moapinterop.org/","trace"=>1,"exceptions"=>0));
$client->__moapCall("echoBoolean", array(1), array("moapaction"=>"http://moapinterop.org/","uri"=>"http://moapinterop.org/"));
