--TEST--
moap Interop Round2 base 005 (moap/direct): echoString(utf-8)
--SKIPIF--
...
$client->__moapCall("echoString", array(new moapParam(new moapVar(utf8_encode('ỗÈéóÒ₧⅜ỗỸ'),XSD_STRING),"inputString")), array("moapaction"=>"http://moapinterop.org/","uri"=>"http://moapinterop.org/"));
