--TEST--
moap Interop Round3 GroupF Headers 003 (php/wsdl): echoString
--SKIPIF--
...
--FILE--
<?php
$hdr = new moapHeader("http://moapinterop.org/xsd","Header2", array("int"=>34,"string"=>"arg"));
