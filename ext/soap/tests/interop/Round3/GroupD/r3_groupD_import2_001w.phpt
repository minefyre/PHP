--TEST--
moap Interop Round3 GroupD Import2 001 (php/wsdl): echoStruct
--SKIPIF--
...
$client = new moapClient(dirname(__FILE__)."/round3_groupD_import2.wsdl",array("trace"=>1,"exceptions"=>0));
