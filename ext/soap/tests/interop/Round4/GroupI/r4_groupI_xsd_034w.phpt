--TEST--
moap Interop Round4 GroupI XSD 034 (php/wsdl): echoVoidmoapHeader(5)
--SKIPIF--
...
--FILE--
<?php
$hdr = new moapHeader("http://moapinterop.org/","echoMeStringRequest", array("varString"=>"Hello World"), 1, moap_ACTOR_NEXT);
