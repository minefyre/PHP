--TEST--
moap Interop Round4 GroupI XSD 032 (php/wsdl): echoVoidmoapHeader(3)
--SKIPIF--
...
--FILE--
<?php
$hdr = new moapHeader("http://moapinterop.org/","echoMeComplexTypeRequest", array("varInt"=>34,"varString"=>"arg","varFloat"=>12.345), 1);
